...
//     version 1.14.0
//     from Assets/J0S!@H/ProjectName/Data/JosiahInput.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/J0S!@H/ProjectName/Data/JosiahInput.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @JosiahInput: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    ~@JosiahInput()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, JosiahInput.Player.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, JosiahInput.UI.Disable() has not been called.");
    }
    ...
    {
        private @JosiahInput m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public PlayerActions(@JosiahInput wrapper) { m_Wrapper = wrapper; }
        /// <summary>
    ...
    public struct UIActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public UIActions(@JosiahInput wrapper) { m_Wrapper = wrapper; }
        /// <summary>
